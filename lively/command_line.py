...
import argparse
import asyncio
from lively.ws_server import (start, default_host, default_port)

def main():
    parser = argparse.ArgumentParser(description='Starts a websocket or epc server for eval requests')
